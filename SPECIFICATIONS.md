...
- The shell mounts in `#game-root`.
- Launch flow shows a legacy-style intro/menu sequence before gameplay starts.
- Selecting **START** transitions from menu shell into active gameplay runtime.
- Creating a new game instance still replaces the previous active instance.
